...
void test_validate_my_username()
{
    ...
    if(TEST_ASSERT_EQUAL_STRING (malloc_username_from_conf_file(), my_username()))
    {
        TEST_ASSERT_TRUE_MESSAGE(TRUE,"Unit test worked");
    }
    else
    {
        TEST_ASSERT_TRUE_MESSAGE(false,"student need to fix it");
    }
}
